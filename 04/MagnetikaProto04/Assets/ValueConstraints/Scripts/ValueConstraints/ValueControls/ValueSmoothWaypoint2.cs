...
namespace ValueConstraints.ValueControls
{
    ...
    /// <summary>
    /// Class for Value SmoothWaypoint2D references
    /// </summary>
    [Serializable]
    public class ValueSmoothWaypoint2 : ValueWaypoint2, IValueSmoothWaypoint
    {
        /// <summary>
        /// Defines an empty or blank value
        /// </summary>
        public new static readonly ValueSmoothWaypoint2 Empty = new ValueSmoothWaypoint2();
